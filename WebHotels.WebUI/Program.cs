...
using Radzen;
using WebHotels.WebUI.Areas.Identity;
...
namespace WebHotels.WebUI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<WebHotels.WebUI.WebHotelsDBService>();
            builder.Services.AddDbContext<WebHotels.WebUI.Data.WebHotelsDBContext>(options =>
            {
                options.UseSqlServer(builder.Configuration.GetConnectionString("WebHotelsDBConnection"));
            });
            builder.Services.AddDbContext<WebHotels.WebUI.Data.WebHotelsDBContext>(options =>
            {
                options.UseSqlServer(builder.Configuration.GetConnectionString("WebHotelsDBConnection"));
